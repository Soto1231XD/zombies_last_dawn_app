          ...
          children: [
            ...
            if (category != null)
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: category.color.withOpacity(0.50)),
                ),
                child: Row(
            ...
            Row(
              children: [
                ...
                const Icon(Icons.comment, size: 15, color: Colors.white54),
